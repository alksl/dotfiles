...
if has("gui_running")
    ...
    highlight Type guifg=#00AFD7
    highlight rubySymbol guifg=#339999 gui=NONE
    highlight Identifier guifg=White gui=NONE
    highlight rubyStringDelimiter guifg=#5FD700
    highlight rubyInterpolation guifg=White
    highlight rubyPseudoVariable guifg=#339999
    highlight Constant guifg=#98FFE7
    highlight Function guifg=#FFCC00 gui=NONE
    highlight Include guifg=#FFCC00 gui=NONE
    highlight Statement guifg=#FF6600 gui=NONE
    highlight String guifg=#5FD700
    highlight Search guibg=White
    highlight CursorLine guibg=#323300
    highlight PreProc guifg=##5FD700
else
    set t_Co=256
    ...
    highlight Type ctermfg=38
    highlight rubySymbol ctermfg=66
    highlight Identifier ctermfg=White
    highlight rubyStringDelimiter ctermfg=76
